...
class NavMain extends React.Component {
  ...
  render() {
    return(<ul className='col-lg-12 navList'>
      <li>
        <IndexLink className='decoration aboutMe'to="/aboutMe" activeClassName="active">SŁOWEM WSTĘPU</IndexLink>
      </li>
      <li>
        <IndexLink className='decoration dziennikarka' to="/dziennikarka" activeClassName="active">DZIENNIKARKA</IndexLink>
      </li>
      <li>
        <IndexLink className='decoration prezenterka' to="/prezenterka" activeClassName="active">PREZENTERKA</IndexLink>
      </li>
      <li>
        <IndexLink className='decoration pisarka' to="/pisarka" activeClassName="active">PISARKA</IndexLink>
      </li>
      <li>
        <IndexLink className='decoration aktorka' to="/aktorka" activeClassName="active">AKTORKA</IndexLink>
      </li>
      <li>
        <IndexLink className='decoration instagram' to="/instagram" activeClassName="active">INSTAGRAM</IndexLink>
      </li>
      <li>
        <IndexLink className='decoration kontakt' to="/kontakt" activeClassName="active">KONTAKT</IndexLink>
      </li>
    </ul>);
  }
}
