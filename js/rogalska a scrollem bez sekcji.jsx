...
scrollTo = (name) => {
  ...
  render() {
    return(
      ...
      <li onClick={() => this.scrollTo({name})} className='decoration'>O MNIE
      </li>
      <li onClick={() => this.scrollTo({Dziennikarka})} className='decoration'>DZIENNIKARKA
      </li>
      <li onClick={() => this.scrollTo({Prezenterka})} className='decoration'>PREZENTERKA
      </li>
      <li onClick={() => this.scrollTo({Pisarka})} className='decoration'>PISARKA
      </li>
      <li onClick={() => this.scrollTo({Aktorka})} className='decoration'>AKTORKA
      </li>
      <li onClick={() => this.scrollTo({Instagram})} className='decoration'>INSTAGRAM
      </li>
      <li onClick={() => this.scrollTo({Kontakt})} className='decoration'>KONTAKT
      </li>
